...
class GameControllerTest {
    ...
    void setUp() {
        ...
        lenient().when(ratingRepository.countByGameIdAndValue(anyLong(), org.mockito.ArgumentMatchers.eq(Rating.Value.DISLIKE))).thenReturn(2L);
    }
    ...
    void getReturnsLocalizedHungarianFields() {
        ...
        assertEquals(2L, response.dislikeCount());
    }
